...
Students should clone the repository from GitHub and then work through Line 300 of this R Notebook before our Digital Lab on March 8th.  COOL.
...
Phylogenies have tips, nodes and edges. Nodes are ancestors to tips. Tips and edges are connected by nodes. Also, recent or derived nodes can  connect to older or ancestral nodesThe details of how tips and nodes connect (via edges) is dictated by the newick code. 
...
Corn and wheat are monocots. Cabbage is a dicot. They are in the same family.
